...
const SearchBar = () => {
    ...
    const city = useSelector(state => state.entities.cities.city);
    ...
    return (
        <>
            <div className="area-text-main">
                {city && params.area.length < 3 && (
                    <h2>{city.name.toUpperCase()} GAME PLACES</h2>
                )}
                {params.area && params.area.length > 3 && (
                    <h2>{params.area.toUpperCase()} GAME PLACES</h2>
                )}
            </div>
